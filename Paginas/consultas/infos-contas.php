...
$sql2 = "SELECT * FROM lancamentos WHERE id_usuario = " . $_SESSION['id'] . " AND metodo_pagamento = 'Pix' OR metodo_pagamento = 'Boleto' OR metodo_pagamento = 'Transferência'"; // Consulta para obter os lançamentos
